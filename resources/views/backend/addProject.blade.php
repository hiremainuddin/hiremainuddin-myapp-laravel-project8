                     ...
                     <div class="card">
                        ...
                        <div class="card-body card-block">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" value="{{ old('title') }}" id="title" placeholder="Project title" class="form-control">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" value="{{ old('description') }}"  name="description" id="description" rows="5"></textarea>
                            ...
                            <div class="form-group">
                                <label for="city" class=" form-control-label">Website</label>
                                <input type="text" id="link" value="{{ old('link') }}"  name="link" placeholder="Add project link" class="form-control">
                                 @if($errors->has('link'))
